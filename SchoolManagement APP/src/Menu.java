        ...
        do {
            ...
            switch (Character.toLowerCase(option)) {
                ...
                while(true){
                    ...
                    Map.Entry<Teacher,ArrayList<Subject>> sensei = info.eachTeacher(subjectName);
                    if (subjectName.equals(sensei.getKey().getFirstName())){
                        System.out.println(sensei);
                        break;
                    } else {
                        System.out.println("Wrong Subject Name or spelling.\nTKry again.");
                    }
                // System.out.println("Do you want to see another Teachers Infomarion?");
                }
